...
const GlassFillSVG = ({ fillHeights, colors, ingredients, textHeights, positions }) => {
    ...
    return (
        <svg width="500px" height="400px" viewBox="9.5 20 45 40" xmlns="http://www.w3.org/2000/svg">
            <rect x="0" y="8" width="64" height="64" fill="white" />
            ...
            <text x="28px" y={(56 + position1) / 2} textAnchor="middle" dominantBaseline="middle" fill="#ba7533" className="small">{ingredient1}</text>

            <text x="28px" y={(position1 + position2) / 2} textAnchor="middle" dominantBaseline="middle" fill="#ba7533" className="small">{ingredient2}</text>

            <text x="28px" y={(position2 + position3) / 2} textAnchor="middle" dominantBaseline="middle" fill="#ba7533" className="small">
                {ingredient3}
            </text>

            <rect x="0" y="56" width="64" height="20" fill="white" />
